            ...
            if i == "1":
                ...
                try:
                    ...
                    while not valid:
                        ...
                        if(choice == "1"):
                            print(
                                "{:2.0f} min".format(self.typeOcarina_orm.getAverageLength()))
                        elif(choice == "2"):
                            print(
                                "{:2.0f} min".format(self.typeOcarina_orm.getMinLength()))
                        elif(choice == "3"):
                            print(
                                "{:2.0f} min".format(self.typeOcarina_orm.getMaxLength()))
                        elif(choice == "4"):
                            print(
                                "{:2.0f} min".format(self.typeOcarina_orm.getTotalLength()))
                        else:
                            valid = False
                            print("Votre choix est faux !")
                except KeyboardInterrupt:
